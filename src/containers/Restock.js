...
export default class VendingMachine extends Component {
  ...
  restockCash = (denom) => {
    ...
    return fetch(`https://vm-cleo-frontend.herokuapp.com//api/v1/machines/1/money/${denom.id}`, {
      method: 'PATCH',
      headers: {
  ...
  restockSnack = (snack) => {
    ...
    return fetch(`https://vm-cleo-frontend.herokuapp.com//api/v1/machines/1/snacks/${snack.id}/`, {
      method: 'PATCH',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json'
